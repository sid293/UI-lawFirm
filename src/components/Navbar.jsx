    ...
    return(
        ...
        <Container maxWidth="xl">
            ...
            <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                ...
                ></IconButton>
                    {pages.map((page) => (
                        <MenuItem key={page} sx={{backgroundColor:"red"}} onClick={handleCloseNavMenu}>
            ...
            <Box sx={{ flexGrow: 0 }}>
                ...
                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                    <button style={{border:"2px solid white",padding:"20px", background:"black",color:"white"}}>CONTACT NOW</button>
                </IconButton>
                </Tooltip>
                <Menu
                sx={{ mt: '45px' }}
